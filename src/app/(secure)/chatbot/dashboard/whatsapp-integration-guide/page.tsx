        ...
        <div className='right' ref={rightRef}>
          ...
          <div className='step-2'>
            ...
            <ol className='ordered-points'>
              ...
              <li>
                ...
                <ul className='unordered-sub-points'>
                  <li>"Log in" to your Meta (Facebook) Developer Account.</li>
                  ...
                  <li>
                    Choose User Case:{' '}
                    <span style={{ fontWeight: 'bold' }}>"Other"</span> and
                    click "Next".
                  </li>
                  ...
                  <li>
                    Choose App Type:{' '}
                    <span style={{ fontWeight: 'bold' }}>"Business"</span> and
                    click "Next".
                  </li>
          ...
          <div className='step-3'>
            ...
            <ol className='ordered-points'>
              ...
              <ul className='unordered-sub-points'>
                ...
                <li>
                  Choose <span className='point-bold-text'>"WhatsApp"</span> for
                  setup.
                </li>
            ...
            <ol className='ordered-points'>
              ...
              <ul className='unordered-sub-points'>
                ...
                <li>
                  ...
                  <span className='point-bold-text'>"Add payment method"</span>{' '}
                  to address the{' '}
                  <span className='point-bold-text'>
              ...
              <ul className='unordered-sub-points'>
                ...
                <li>
                  Enter a testing <span className='point-bold-text'>"To"</span>{' '}
                  number.
                </li>
                <li>
                  Click <span className='point-bold-text'>"Send message"</span>{' '}
          ...
          <div className='step-5'>
            ...
            <ol className='ordered-points'>
              ...
              <ul className='unordered-sub-points'>
                <li>
                  Under "<span className='point-bold-text'>Webhook Fields</span>
                ...
                <li>
                  Find the <span className='point-bold-text'>"messages"</span>{' '}
