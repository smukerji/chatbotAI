          ...
          <div className="step-1">
            ...
            <ol className="ordered-points">
              ...
              <ul className="unordered-sub-points">
                ...
                <div className="steps-img">
                  <Image src={step2_1} alt="step1_8" />
                </div>

                <li>It will ask permission, click on allow</li>

                <div className="steps-img">
                  <Image src={step2_1} alt="step1_9" />
                </div>
                ...
                <div className="steps-img">
                  <Image src={step2_1} alt="step1_10" />
                </div>
                ...
                <div className="steps-img">
                  <Image src={step2_1} alt="step1_11" />
                </div>
                ...
                <div className="steps-img">
                  <Image src={step2_1} alt="step1_12" />
                </div>
                ...
                <div className="steps-img">
                  <Image src={step2_1} alt="step1_13" />
                </div>
                ...
                <div className="steps-img">
                  <Image src={step2_1} alt="step1_14" />
                </div>
              </ul>
            </ol>
          </div>
