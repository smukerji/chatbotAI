      ...
      <div className="eval-content-wrapper">
        <Card className="eval-form-card" bordered={false}>
          <div className="eval-header">
            <Button type="text" icon={<LeftOutlined />} className="back-btn" />
            ...
            <Form layout="vertical">
              ...
              <div className="conversation-section">
                <div className="toggle-group">
                  <Button
                    type={activeToggle === "assistant" ? "primary" : "default"}
                    className={`toggle ${
                ...
                <Button
                  icon={
                    <img
                      src="/svgs/add.svg"
                      alt="Add"
                      style={{ width: 24, height: 16, verticalAlign: "middle" }}
                    />
                  }
