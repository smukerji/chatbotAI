    ...
    <div className="terms-privacy-container">
      ...
      <div className="term-container">
        ...
        <p>
          ...
          referred to collectively as the “Service”. This Privacy Policy governs
          the types of information and data we collect and how we use and share
          this information. Your access to and use of the Service are available
          for your use only on the condition that you agree to the Terms &
          Conditions available under the following address:
          <a href={`/terms`}>{process.env.NEXT_PUBLIC_WEBSITE_URL}terms</a>
          (“Terms & Conditions”) which include the terms of the Privacy Policy
          set forth below. Torri.AI (“Company”) operates the Service.We use your
      ...
      <div className="term-container">
        ...
        <p>
          ...
          Device, your operating system, the type of Internet browser you use,
      ...
      <div className="term-container">
        ...
        <ul>
          ...
          <li>
            ...
            collection; type of Personal Data: email address, first name and
          ...
          <li>
            ...
            Cookies and Usage Data; necessity for the performance of a contract
      ...
      <div className="term-container">
        ...
        <p>
          ...
          States and process it there. The Company will take all the steps
          ...
          data and other personal information. When we transfer your Personal
          Data to other countries, we will protect that Personal Data as
          described in this Privacy Policy and in accordance with applicable
          law. We use contractual protections for the transfer of Personal Data
          among various jurisdictions (the European Commission’s standard
          contractual clauses referred to in Article 46. 2 c) of the GDPR).
        </p>
      </div>
